...
export class Food99ConfirmService {
  async verifyOrderCode(
    ...
    try {
      ...
      const pageUrl = 'https://food-b-h5.99app.com/pt-BR/v2/confirmation-entrega/locator';
      ...
      if (page) {
        await page.screenshot({ path: `/tmp/99food-error-${Date.now()}.png`, fullPage: true }).catch(() => {});
